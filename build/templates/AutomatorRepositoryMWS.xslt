    ...
    <Projects>
      ...
      <Project  type="Repository" overwrite="true" ignoreMissingDependencies="true">
        ...
        <DeploymentSet autoResolve="ignore">
          ...
          <xsl:attribute name="description">
            <xsl:value-of select="concat($projectName,' MWS DeploymentSet')"/>
          </xsl:attribute>
		...
		<DeploymentMap>			
	         <xsl:attribute name="description">
	            <xsl:value-of select="concat($projectName,' MWS Deployment Map')"/>
	         </xsl:attribute>
		...
		<DeploymentCandidate>
	         ...
	         <xsl:attribute name="description">
	            <xsl:value-of select="concat($projectName,' MWS Deployment Candidate')"/>
	         </xsl:attribute>
